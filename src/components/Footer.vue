...
<template>
  ...
  >
    <div class="p-10 bg-muted/50 dark:bg-card border">
      <div
        class="container grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8"
      >
        <div class="col-span-full xl:col-span-2">
          ...
          >
            ...
            <h3 class="text-2xl">Source One Floor</h3>
          </a>
        </div>
